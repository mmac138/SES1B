...
public class DoctorChatSearchFragment extends Fragment{
    ...
    private static final String TAG = "Doctor search user";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Query query = FirebaseDatabase.getInstance().getReference().child("Patient").orderByChild("email").equalTo(inputText);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.exists()){
                            ...
                            for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                                ...
                                ChatDetails.chatWith = patient.getName();
                                Log.d(TAG, "ChatWith: " + ChatDetails.chatWith);
                                break;
                            }
                            ChangeFragment(new DoctorChatFragment());

                        }
                        else{
                            resultTextView.setText("Cannot find this patient!!!");
                        }
                    }
